...
function activate(context) {
    ...
    commands_1.registerExtensionCommands(context);
}
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CommandNames = exports.Command = exports.registerExtensionCommands = exports.collectCommands = void 0;
const vscode_1 = __webpack_require__(3);
const commandsConstructor = [];
...
class Command {
    constructor(name) {
        this._dispose = vscode_1.commands.registerCommand(name, (...args) => {
            this.excute(...args);
        });
    }
    dispose() {
...
(function (CommandNames) {
    CommandNames["FULL_COVERAGE"] = "matman.fullcoverage";
    CommandNames["INCREMENT_COVERAGE"] = "matman.incrementcoverage";
...
const xml2js_1 = __webpack_require__(6);
const common_1 = __webpack_require__(2);
const information_1 = __webpack_require__(50);
const statusBar_1 = __webpack_require__(51);
const decoration_1 = __webpack_require__(52);
const utils_1 = __webpack_require__(53);
let FullCoverage = class FullCoverage extends common_1.Command {
    constructor() {
        super(common_1.CommandNames.FULL_COVERAGE);
    }
    parseLocv() {
        return __awaiter(this, void 0, void 0, function* () {
            const dwtConfigPath = vscode.workspace
                ...
                .toString();
            const lcovPath = utils_1.getLcovPath(dwtConfigPath);
            ...
            decoration_1.removeDecoration(editor, lineCount);
            const data = yield this.getParseData(vscode.workspace.rootPath +
    ...
    // 获取解析好的数据
    getParseData(lcovPath) {
        return xml2js_1.parseStringPromise(fs_1.readFileSync(lcovPath));
    }
    // 判断是否选择了正确的文件进行渲染
    chooseCorrectFile(data, fileName) {
        const arr = data;
        let flag = false;
        arr.forEach((info) => {
            if (fileName.toLocaleLowerCase().includes(info.file.toLocaleLowerCase())) {
                flag = true;
            }
        });
        if (!flag) {
            information_1.showWarning('当前文件未被覆盖！');
        }
        return flag;
    }
    // 渲染文件
    renderFile(data, fileName, lineCount) {
        const arr = data;
        let curFile = '';
        let curHit = 0;
        let curFound = 0;
        arr.forEach((info) => {
            ...
            if (fileName.toLocaleLowerCase().includes(info.file.toLocaleLowerCase())) {
                ...
                if (lineCount && details[len - 1].line > lineCount) {
                    information_1.showWarning('覆盖率文件未更新，渲染测试用例行数有误');
                    return;
                }
                // 渲染文件
                details.forEach((detail) => {
                    decoration_1.decoration(detail.line - 1, detail.hit);
                });
            }
        });
    ...
    // 计算当前文件覆盖率
    computeCurrentCovRate(fileName, hit, found) {
        const currentCovRate = (hit / found) * 100;
        const currentPath = utils_1.getFilePath(fileName);
        information_1.showInformation(`${currentPath}覆盖率为: ${currentCovRate.toFixed(2)}%`);
    }
    // 计算全量覆盖率
    computeTotalCovRate(data) {
        const arr = data;
        // 统计总行数以及hit到的行数
        let totalFound = 0;
        let totalHit = 0;
        ...
        statusBar_1.setStatusBar(`全量覆盖率为: ${totalCovRate.toFixed(2)}%`);
    }
    excute() {
        return __awaiter(this, void 0, void 0, function* () {
            this.parseLocv();
...
FullCoverage = __decorate([
    common_1.collectCommands()
], FullCoverage);
...
(function() {
  ...
  defaults = __webpack_require__(7);

  builder = __webpack_require__(8);

  parser = __webpack_require__(42);

  processors = __webpack_require__(48);
...
(function() {
  ...
  defaults = __webpack_require__(7).defaults;
...
(function() {
  ...
  XMLDOMImplementation = __webpack_require__(11);

  XMLDocument = __webpack_require__(12);

  XMLDocumentCB = __webpack_require__(40);

  XMLStringWriter = __webpack_require__(37);

  XMLStreamWriter = __webpack_require__(41);

  NodeType = __webpack_require__(18);

  WriterState = __webpack_require__(39);
...
(function() {
  ...
  XMLDOMConfiguration = __webpack_require__(13);

  XMLNode = __webpack_require__(16);
...
(function() {
  ...
  XMLDOMErrorHandler = __webpack_require__(14);

  XMLDOMStringList = __webpack_require__(15);
...
(function() {
  ...
  ref1 = __webpack_require__(10), isObject = ref1.isObject, isFunction = ref1.isFunction, isEmpty = ref1.isEmpty, getValue = ref1.getValue;
  ...
  module.exports = XMLNode = (function() {
    function XMLNode(parent1) {
      ...
      if (!XMLElement) {
        ...
        XMLDummy = __webpack_require__(33);
        NodeType = __webpack_require__(18);
        XMLNodeList = __webpack_require__(34);
        XMLNamedNodeMap = __webpack_require__(20);
        DocumentPosition = __webpack_require__(35);
      }
    }
...
(function() {
  ...
  ref = __webpack_require__(10), isObject = ref.isObject, isFunction = ref.isFunction, getValue = ref.getValue;

  XMLNode = __webpack_require__(16);

  NodeType = __webpack_require__(18);

  XMLAttribute = __webpack_require__(19);
...
(function() {
  ...
  XMLCharacterData = __webpack_require__(22);
...
(function() {
  ...
  XMLWriterBase = __webpack_require__(38);
...
(function() {
  ...
  ref = __webpack_require__(10), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject, getValue = ref.getValue;
...
(function() {
  ...
  sax = __webpack_require__(43);

  events = __webpack_require__(46);

  bom = __webpack_require__(47);

  processors = __webpack_require__(48);

  setImmediate = __webpack_require__(49).setImmediate;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.showError = exports.showWarning = exports.showInformation = void 0;
const vscode = __webpack_require__(3);
function markdownString(info) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.removeDecoration = exports.decoration = void 0;
const vscode = __webpack_require__(3);
const DecorationArr = [];
function createDecorationType(hit, theme) {
    if (hit) {
...
function setDecoration(editor, decorationType, line) {
    editor.setDecorations(decorationType, [
        new vscode.Range(line, 0, line, editor.document.lineAt(line).text.length),
    ]);
}
function decoration(line, hit) {
    // 获取vscode主题
...
function removeDecoration(editor, lineCount) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.getLcovPath = exports.getFilePath = void 0;
const vscode = __webpack_require__(3);
const os_1 = __webpack_require__(54);
// 获取文件路径
...
function getLcovPath(dwtConfigPath) {
    const platform = os_1.getOS();
    let lcovPath = '';
    if (platform === 'MAC OS') {
        lcovPath = vscode.workspace.rootPath + os_1.getFileSeparator() + dwtConfigPath;
    }
...
exports.getLcovPath = getLcovPath;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.getFileSeparator = exports.getOS = void 0;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.IncrementCoverage = void 0;
const vscode = __webpack_require__(3);
const child_process_1 = __webpack_require__(57);
const common_1 = __webpack_require__(2);
const gitdiff_parser_1 = __webpack_require__(58);
const information_1 = __webpack_require__(50);
const statusBar_1 = __webpack_require__(51);
const decoration_1 = __webpack_require__(52);
const utils_1 = __webpack_require__(53);
...
let IncrementCoverage = class IncrementCoverage extends common_1.Command {
    constructor() {
        super(common_1.CommandNames.INCREMENT_COVERAGE);
    }
    parseLocv() {
        return __awaiter(this, void 0, void 0, function* () {
            const dwtConfigPath = vscode.workspace
            ...
            decoration_1.removeDecoration(editor, lineCount);
            // 获取lcov覆盖率数据
            const data = yield this.getParseData(lcovPath);
            // 判断是否选择了可以计算增量覆盖率的文件
            const flag = this.chooseCorrectFile(data, fileName);
            if (!flag) {
                return;
            }
            child_process_1.exec('git diff -U0', { cwd: vscode.workspace.rootPath }, (err, stdout, stderr) => {
                if (err) {
                    console.log(err);
                    return;
                }
                // 获取git diff数据
                const diffData = gitdiff_parser_1.default.parse(stdout);
                // 判断是否选择了有变动代码的文件
    ...
    // 判断选中的文件是否有增量代码
    chooseDiffFile(diffData, fileName) {
        let diff = false;
        ...
        if (!diff) {
            information_1.showWarning('该文件没有增量代码');
        }
        return diff;
    }
    // 计算增量覆盖率
    computeIncrementCovRate(data, diffData, fileName) {
        const arr = data;
        let totalIncreLine = 0;
        let covIncreLine = 0;
        arr.forEach((info) => {
            diffData.forEach((diffItem) => {
                const lcovFilePath = info.file;
                const diffFilePath = diffItem.newPath;
                if (lcovFilePath === diffFilePath) {
                    let curTotalIncreLine = 0;
                    let curCovIncreLine = 0;
                    // 统计变换了的行号
                    const diffLineArr = [];
                    ...
                    if (fileName.includes(lcovFilePath) &&
                        fileName.includes(diffFilePath) &&
                        intersectArr.length) {
                        this.computeCurIncrementRate(fileName, curCovIncreLine, curTotalIncreLine);
        ...
        if (totalIncreLine) {
            ...
            statusBar_1.setStatusBar(`增量覆盖率为: ${totalIncreCovRate.toFixed(2)}%`);
        }
    }
    // 计算当前文件增量覆盖率
    computeCurIncrementRate(fileName, curCovIncreLine, curTotalIncreLine) {
        const curIncreCovRate = (curCovIncreLine / curTotalIncreLine) * 100;
        const currentPath = utils_1.getFilePath(fileName);
        information_1.showInformation(`${currentPath}的增量覆盖率为: ${curIncreCovRate.toFixed(2)}%`);
    }
    // 渲染文件
    renderFile(intersectArr, lcovLineHit) {
        intersectArr.forEach((line) => {
            const hit = lcovLineHit.get(line);
            decoration_1.decoration(line - 1, hit);
        });
    }
    excute() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.parseLocv();
        });
    }
};
IncrementCoverage = __decorate([
    common_1.collectCommands()
], IncrementCoverage);
exports.IncrementCoverage = IncrementCoverage;
